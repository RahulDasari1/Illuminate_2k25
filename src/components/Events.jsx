...
const Events = () => {
  ...
  return (
    <div id='events' className='py-10 px-10 scroll-mt-20'>
        ...
        <div className='flex gap-15 shrink-0 flex-wrap justify-center items-center relative overflow-hidden pb-10'>
